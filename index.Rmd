...
I will probably be asking you to turn in assignments using R Markdown. Markdown is a way to present your code-based projects as a more polished document (you're reading a markdown right now!). 
...
You can use this tool to make repeatable reporting workflows for non-techincal audience using R. [I often write data reports like this one for my clients](https://voicesofcreativedata.nighttime.org/), where I "hide" all the code and just show the outputs.

If you want to read more about how markdown works - you can find a download button at the top right of this document and download the code that was used to make this.
