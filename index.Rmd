...
This document will be updated on an ongoing basis (it's a construction site). Right now, sections 1-10 are complete - which is what students in CPLN 675 will need to get up and running this spring!
...
- Your collaborator can clone the project, and then push and pull things themselves. This will help you manage changes and versions. If you keep all your code and data inside the Github folder, the file paths will all be the same and it will be easy to collaborate.
