...
New additions for 2023 will include tips on how to organize your R Projects, R scripts, data, markdowns and more.

# 12. Querying APIs and Reading Data from Web Sources

New additions for 2023 will include vignettes on Socrata and REST API query functionalities for R, and using two-factor authentification with boxr and PennBox.

Presently, vignettes for boxr can be found [https://github.com/mafichman/boxr](at this repo).

# 13. Other Spatial Packages

New additions for 2023 will include vignettes on the following packages - Mapview, Leaflet, osmdata, raster/terra, and crs_suggest.
