...
*For years, I've been teaching data analysis, statistical modeling, and spatial analysis to Penn Planning and Spatial Analytics grad students using the software language R. It's always a challenge to get started with some basics so we can move quickly to applied work.*

*This is a working document designed to give a basic introduction to R. This isn't a "coding" tutorial, it's a starter kit that demonstrates some simple Excel or ArcGIS-like tasks - loading spreadsheets and spatial data, creating new columns of data, summarizing and querying data, making charts and maps. *
...
*This document will be updated on an ongoing basis - (apologies if it looks like a construction site at times). Right now, sections 1-8 are complete - which is what students in CPLN 675 will need to get up and running this spring!*
