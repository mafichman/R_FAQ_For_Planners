...
For years, I've been teaching data analysis, statistical modeling, and spatial analysis to Urban Planning and Spatial Analytics graduate students using the software language R. It's always a challenge to get students started with some basics so that we can move quickly to applied methods and concepts. As students get more sophisticated, there are some common questions and issues that many confront.
...
You can load data from the web, like from Google Drive or Github, using the same kind of syntax:
...
Now that you've loaded in some data, you can examine them in several ways. You can `View(myData)` and see a visual representation of the data in an excel-like way, or you can `glimpse` the data.
